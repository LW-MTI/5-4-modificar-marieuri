...
public class NuevaEntidad extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NuevaEntidad</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NuevaEntidad at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String nuevaEntidad= request.getParameter("nombreentidad");
       String pais = request.getParameter("pais");
       int idpais= Integer.parseInt(pais);
      
       p.write(ejb.nuevaEntidad(nuevaEntidad,idpais));
    }
