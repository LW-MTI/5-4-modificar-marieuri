 ...
 * @author marieuri
 */
@WebServlet(name = "NuevoRecursoMultimedia", urlPatterns = {"/NuevoRecursoMultimedia"})
public class NuevoRecursoMultimedia extends HttpServlet {
@EJB private 
        EJBOperaciones ejb;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NuevoRecursoMultimedia</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NuevoRecursoMultimedia at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
