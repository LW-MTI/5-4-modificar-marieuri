 ...
 * @author marieuri
 */
@WebServlet(name = "NuevoLugarTuristico", urlPatterns = {"/NuevoLugarTuristico"})
public class NuevoLugarTuristico extends HttpServlet {
@EJB private 
        EJBOperaciones ejb;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NuevoLugarTuristico</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NuevoLugarTuristico at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       char t=tipolugar.charAt(0);          //DUDA
       int m =Integer.parseInt(idmarca);    //DUDA
       p.write(ejb.nuevoLugarTuristico(descripcion,t,m,nombrelugar));
    }
